        ...
        <div className="content-container">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            <motion.div 
              ...
              className="md:col-span-2 lg:col-span-2 relative h-[320px] sm:h-[380px] md:h-[340px] lg:h-[520px] rounded-[30px] md:rounded-[40px] overflow-hidden group shadow-sm cursor-pointer"
            >
              <img 
                src={sideImageUrl} 
            ...
            <motion.div 
              ...
              className="bg-card-blue p-6 sm:p-8 md:p-6 lg:p-8 xl:p-12 rounded-[30px] md:rounded-[40px] flex flex-col justify-between h-[450px] md:h-[360px] lg:h-[520px] group cursor-pointer shadow-sm border border-black/[0.02]"
            >
              <div>
                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-md mb-6 md:mb-8">
                  <Mail className="w-5 h-5 text-[#3E5C7A]" />
                </div>
                <h3 className="text-xl sm:text-2xl md:text-[1.15rem] lg:text-[1.25rem] xl:text-[1.65rem] font-sans font-medium text-brand-ink mb-4 md:mb-6 leading-tight min-h-[56px] md:min-h-[64px] lg:min-h-[80px] flex items-end">
            ...
            <motion.div 
              ...
              className="bg-white border border-black/5 p-6 sm:p-8 md:p-6 lg:p-8 xl:p-12 rounded-[30px] md:rounded-[40px] flex flex-col justify-between h-[450px] md:h-[360px] lg:h-[520px] group cursor-pointer shadow-sm"
            >
              <div>
                <div className="w-12 h-12 bg-[#F8F6F3] rounded-full flex items-center justify-center shadow-sm mb-6 md:mb-8">
                  <Phone className="w-5 h-5 text-[#8C7662]" />
                </div>
                <h3 className="text-xl sm:text-2xl md:text-[1.15rem] lg:text-[1.25rem] xl:text-[1.65rem] font-sans font-medium text-brand-ink mb-4 md:mb-6 leading-tight min-h-[56px] md:min-h-[64px] lg:min-h-[80px] flex items-end">
                  <span>Написати в <br className="hidden md:block lg:hidden xl:block" /><span className="md:whitespace-nowrap lg:whitespace-normal xl:whitespace-nowrap">WhatsApp / Telegram</span></span>
                </h3>
                <p className="text-brand-muted text-sm md:text-xs lg:text-sm xl:text-base leading-relaxed max-w-[280px]">
