...
export default function Hero({ onOpenContact }: HeroProps) {
  ...
  return (
    <section className="relative min-h-[100svh] w-full overflow-hidden bg-brand-dark flex flex-col justify-end pt-24 sm:pt-28 pb-0">
      ...
      <div className="content-container relative z-10 w-full flex flex-col justify-end pb-24 sm:pb-28 md:pb-32 lg:pb-44">
        <div className="grid lg:grid-cols-12 gap-10 md:gap-12 items-end">
          ...
          <div className="lg:col-span-8">
            <motion.div
              ...
              className="space-y-5 sm:space-y-6 md:space-y-8 max-w-3xl"
            >
              <h1 className="text-[32px] xs:text-[36px] sm:text-5xl md:text-6xl lg:text-7xl xl:text-[5rem] leading-[1.12] sm:leading-[1.08] md:leading-[0.95] text-white font-medium tracking-tight break-words">
              ...
              <motion.div 
                ...
                className="max-w-2xl space-y-5 sm:space-y-8 md:space-y-12"
              >
                ...
                <p className="text-white/95 text-[15px] sm:text-base md:text-xl font-normal leading-relaxed max-w-xl">
                  {t.hero.description.line1} <br className="hidden md:block" /> 
                  {t.hero.description.line2}
                </p>

                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 md:gap-5 w-full pt-1 sm:pt-2">
                  <button 
